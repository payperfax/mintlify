...
Fax standard resolution is **204×196 dots per inch (dpi)**.

This is much lower than typical documents (300-600 dpi), which is why fax confirmations appear pixelated on modern screens.

**Despite the low resolution**:
- Text remains readable in 99% of cases
- This is the universal fax standard worldwide
- All fax machines use this resolution

See [Why Confirmations Look Low Quality](/troubleshooting/low-quality-confirmations) for more information.
</Accordion>
